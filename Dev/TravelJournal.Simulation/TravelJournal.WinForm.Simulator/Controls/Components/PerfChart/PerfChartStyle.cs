...
namespace TravelJournal.WinForm.Simulator.Controls
{
    ...
    public class PerfChartStyle
    {
        ...
        private Color backgroundColorTop = DarkThemeColor.DimDarkBlack;
        private Color backgroundColorBottom = DarkThemeColor.DimLightBlack;
    ...
    public class ChartPen
    {
        ...
        public ChartPen() {
            pen = new Pen(Color.FromArgb(42, 42, 42));
        }
