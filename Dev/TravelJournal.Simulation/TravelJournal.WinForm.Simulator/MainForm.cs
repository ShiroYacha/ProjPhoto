...
namespace TravelJournal.WinForm.Simulator
{
    public partial class MainForm : Form
    {
        ...
        {
            ITestWindow testWindow = (Activator.CreateInstance("TravelJournal.WinForm.Simulator", "TravelJournal.WinForm.Simulator."+projectTag as string) as ObjectHandle).Unwrap() as ITestWindow;
        ...
        {
            if (mainTableLayoutPanel.Controls.Count == 2) (mainTableLayoutPanel.Controls[1] as ITestWindow).CloseDown();
        }
    }
}
